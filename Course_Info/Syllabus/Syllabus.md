...
The full course policies live in the **Course Policies** section of this site:
[Attendance, Deadlines, and Regrades](../../Policies/Deadlines.md);
[Collaboration, Academic Integrity, and AI](../../Policies/Integrity.md), which includes the rules for generative AI;
[Accessibility and Accommodations](../../Policies/Accessibility.md);
and the [Inclusive Classroom](../../Policies/Inclusion.md) policies on language and caregiving.
By staying enrolled in the course you agree to follow them, so please read them during the first week.
